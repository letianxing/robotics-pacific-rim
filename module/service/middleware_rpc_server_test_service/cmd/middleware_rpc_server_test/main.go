...
import (
	...
	generatedapi "github.com/pacific-rim/pacific-rim/module/service/middleware_rpc_server_test_service/internal/api/generated"
	"github.com/pacific-rim/pacific-rim/module/service/middleware_rpc_server_test_service/internal/service"
)
...
func main() {
	...
	runtime, err := commbootstrap.BootstrapCommunication(ctx, *configPath, "middleware_rpc_server_test_service")
	if err != nil {
	...
	if err := app.Run(ctx); err != nil && !errors.Is(err, context.Canceled) {
		log.Fatalf("run middleware_rpc_server_test: %v", err)
	}
}
