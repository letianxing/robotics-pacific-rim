...
package_name = "middleware_sub_test"
...
setup(
  ...
  data_files=[
    ...
    (f"share/{package_name}/launch", ["launch/middleware_sub_test.launch.py"]),
  ...
  description="Middleware Sub Test ROS2 Python module.",
  license="TODO",
  entry_points={
    "console_scripts": [
      "middleware_sub_test_node = middleware_sub_test.node:main",
    ],
  },
)
